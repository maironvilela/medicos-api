...
public record DadosMedicosGetByIdResponse(Long id, String nome, String telefone , String email, String crm, Especialidade especialidade, Endereco endereco) {

    public DadosMedicosGetByIdResponse(Medico medico){
