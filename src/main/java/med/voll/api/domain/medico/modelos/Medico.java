package med.voll.api.domain.medico.modelos;
...
import med.voll.api.domain.medico.types.DadosAtualizarMedico;
import med.voll.api.domain.medico.types.DadosCadastroMedico;
import med.voll.api.domain.medico.types.Especialidade;
